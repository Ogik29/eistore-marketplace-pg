...
@section('content')
    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container-fluid">
            ...
            <!-- row untuk button add new product -->
            <div class="row">
                <div class="col-12">
            ...
            <div class="row mt-4">
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-product d-block">
                        ...
                        <div class="product-title">Gecko Hitam Jomokerto</div>
                        <div class="product-category">Pet</div>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-product d-block">
                        ...
                        <div class="product-title">Kopi Hitam Ngawi</div>
                        <div class="product-category">Drink</div>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-product d-block">
                        ...
                        <div class="product-title">Rambak Sapi Ngawirejo</div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-product d-block">
                        ...
                        <div class="product-title">TWS Hitam</div>
                        <div class="product-category">Device</div>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-product d-block">
                        ...
                        <div class="product-title">Anggrek Mekar Pontianak</div>
                        <div class="product-category">Flower</div>
                        </div>
                    </a>
                </div>
            </div>
